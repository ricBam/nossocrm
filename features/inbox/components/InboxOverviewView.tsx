    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={onGoToList}
            className="flex-1 sm:flex-none justify-center inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
          >
            Ver lista
          ...
          <button
            ...
            className="flex-1 sm:flex-none justify-center inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-primary-600 text-white text-sm font-semibold hover:bg-primary-700 transition-colors disabled:opacity-50"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-4">
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            <button
              onClick={onGoToList}
              className="shrink-0 text-sm font-semibold text-primary-600 dark:text-primary-400 hover:underline"
            >
              Ver tudo
            </button>
          </div>
