...
export function ResultDetail({
    ...
    return (
        <aside className="fixed inset-y-0 right-0 z-[9998] w-full max-w-md overflow-y-auto border-l border-slate-200 bg-white p-4 pb-[calc(1rem+var(--app-safe-area-bottom,0px))] shadow-xl dark:border-slate-700 dark:bg-slate-900 md:pb-4">
            <div className="mb-3 flex items-start justify-between gap-2">
                ...
                <Button variant="ghost" size="sm" className="shrink-0" onClick={onClose}>Fechar</Button>
            </div>
            ...
            <dl className="mb-4 space-y-1 text-sm">
                <div className="flex justify-between gap-2"><dt className="text-slate-500">Endereço</dt><dd className="min-w-0 break-words text-right">{p.address ?? '—'}</dd></div>
